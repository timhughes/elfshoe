...
from ipxe_menu_gen import MenuGenerator, BootEntry, DistributionMenu
...
class TestMenuGenerator:
    ...
    def test_error_handlers_included(self, sample_config):
        ...
        assert 'prompt --timeout 30000' in output
    ...
    def test_chain_error_handler(self):
        ...
        config = {
            ...
            'distributions': {},
            'additional_items': [
                {'id': 'netboot', 'label': 'Netboot', 'type': 'chain', 'url': 'http://boot.netboot.xyz'},
